...
//slope of midnormal
    ...
    private void init(Context ctx, AttributeSet attrs) {
        ...
        collapsedRadius = ta.getDimensionPixelSize(R.styleable.FilterMenuLayout_cm_collapsedRadius, defaultCollapsedRadius);
        expandedRadius = ta.getDimensionPixelSize(R.styleable.FilterMenuLayout_cm_expandedRadius, defaultExpandedRadius);


        centerLeft = ta.getDimensionPixelSize(R.styleable.FilterMenuLayout_cm_centerLeft, 0);
        centerRight = ta.getDimensionPixelSize(R.styleable.FilterMenuLayout_cm_centerRight, 0);
        centerTop = ta.getDimensionPixelSize(R.styleable.FilterMenuLayout_cm_centerTop, 0);
        centerBottom = ta.getDimensionPixelSize(R.styleable.FilterMenuLayout_cm_centerBottom, 0);
        centerHorizontal = ta.getBoolean(R.styleable.FilterMenuLayout_cm_centerHorizontal, false);
        centerVertical = ta.getBoolean(R.styleable.FilterMenuLayout_cm_centerVertical, false);

        primaryColor = ta.getColor(R.styleable.FilterMenuLayout_cm_primaryColor, getResources().getColor(android.R.color.holo_blue_bright));
        primaryDarkColor = ta.getColor(R.styleable.FilterMenuLayout_cm_primaryDarkColor, getResources().getColor(android.R.color.holo_blue_dark));
        ta.recycle();
